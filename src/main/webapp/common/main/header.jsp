...
<nav class="navbar navbar-expand-lg navbar-dark navbar-modern fixed-top">
    <div class="container">
        <a class="navbar-brand fw-bold text-uppercase text-white" href="<c:url value='/waiting'/>">
            <i class="fa-solid fa-film text-danger me-2"></i>RoMinh
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav me-auto">
                <li class="nav-item">
                    <a class="nav-link mx-2" href="<c:url value='/waiting'/>">
                ...
                <c:if test="${sessionScope.account != null}">
                    <li class="nav-item me-3">
                        <a class="nav-link" href="<c:url value='/profile'/>">
                            ...
                            Xin chào, <span class="text-info fw-bold">${sessionScope.account.fullname}</span>
                        </a>
                    </li>
                    <li class="nav-item">
