...
<div class="card shadow mb-4" style="max-width: 600px; margin: 0 auto;">
    <div class="card-header py-3 bg-warning text-white">
        <h6 class="m-0 fw-bold text-dark">Cập nhật danh mục</h6>
    </div>
    <div class="card-body">
        <form action="<c:url value='/manager/category/edit'/>" method="post" enctype="multipart/form-data">
            ...
            <div class="d-grid gap-2">
                ...
                <a href="<c:url value='/manager/home'/>" class="btn btn-secondary">Hủy bỏ</a>
            </div>
        </form>
    </div>
</div>